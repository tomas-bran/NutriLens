/**
 * <HistoryListView> — `/catalogo` body (spec E04 §6.1 / §6.3 / §6.4).
 *
...
export function HistoryListView({ items, page, totalPages, total, filters }: HistoryListViewProps) {
  ...
  return (
    <div className="flex flex-col gap-6 px-4 py-2 md:px-6 md:py-6" data-testid="catalogo-view">
  ...
  return (
    <header className="flex flex-wrap items-end justify-between gap-3">
      <div className="flex flex-col gap-0.5">
        ...
        {total > 0 && (
          <p className="text-[13px] text-[var(--color-text-muted)]" data-testid="catalogo-total">
      ...
      <Link
        href="/analizar"
        data-testid="catalogo-new-analysis"
