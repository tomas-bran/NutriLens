...
describe('<MobileBottomNav>', () => {
  ...
  it('marca el item activo con aria-current="page"', () => {
    render(<MobileBottomNav active="historial" />);
    expect(screen.getByTestId('bottom-nav-historial')).toHaveAttribute('aria-current', 'page');
  ...
  it('muestra un punto en Historial cuando historialCount > 0', () => {
    render(<MobileBottomNav active="inicio" historialCount={5} />);
    const link = screen.getByTestId('bottom-nav-historial');
  ...
  it('no muestra el punto cuando historialCount es 0', () => {
    render(<MobileBottomNav historialCount={0} />);
    const link = screen.getByTestId('bottom-nav-historial');
